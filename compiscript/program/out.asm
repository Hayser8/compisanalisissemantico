...
[EMITTER] fn=Animal::speak frame_size(plan)=8 has_calls=False
[EMITTER]   s_regs_in_use=[]
[EMITTER]   local_off={}
[EMITTER]   param_home_off={}
[EMITTER]   need_param_homes=0
[EMITTER]   most_neg_offset=0
[EMITTER]   frame_bytes(final)=256
[EMITTER] ===== ASM for Animal::speak (frame(plan)=8) =====
    Animal__speak:
      addiu $sp, $sp, -256
      sw $fp, 0($sp)
      sw $ra, 4($sp)
...
[EMITTER] fn=Dog::bark frame_size(plan)=8 has_calls=True
[EMITTER]   s_regs_in_use=[]
[EMITTER]   local_off={}
[EMITTER]   param_home_off={}
[EMITTER]   need_param_homes=0
...
[EMITTER]     flushing names: []
[EMITTER] ===== ASM for Dog::bark (frame(plan)=8) =====
    Dog__bark:
      addiu $sp, $sp, -256
      sw $fp, 0($sp)
      sw $ra, 4($sp)
...
[EMITTER] fn=A::get frame_size(plan)=8 has_calls=False
[EMITTER]   s_regs_in_use=[]
[EMITTER]   local_off={}
[EMITTER]   param_home_off={}
[EMITTER]   need_param_homes=0
[EMITTER]   most_neg_offset=0
[EMITTER]   frame_bytes(final)=256
[EMITTER] ===== ASM for A::get (frame(plan)=8) =====
    A__get:
      addiu $sp, $sp, -256
      sw $fp, 0($sp)
      sw $ra, 4($sp)
